...
COMMENT ON FUNCTION public.signup IS 'Register new user with bcrypt password hashing';
COMMENT ON FUNCTION public.login IS 'Authenticate user and return JWT token (7-day expiration)';
